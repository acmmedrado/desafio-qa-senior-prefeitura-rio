...
| Webhook deve validar integridade do payload | Seguranca | `test_webhook_rejects_missing_signature`, `test_webhook_rejects_invalid_signature`, `test_webhook_rejects_signature_created_with_wrong_secret`, `test_webhook_rejects_signature_from_different_payload` | BUG-004 |
...
- Quality gate: 45 testes passando.
- Release gate: 8 falhas bloqueantes.
